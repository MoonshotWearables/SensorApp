...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_pass_field = (EditText) findViewById(R.id.reg_pswd);
        reg_confirm_pass_field = (EditText) findViewById((R.id.reg_pswd_confirm));
        ...
        reg_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String pswd = reg_pass_field.getText().toString();
                String confirm_pswd = reg_confirm_pass_field.getText().toString();

                if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(pswd) && !TextUtils.isEmpty(confirm_pswd)){
